...
class WATemplate(models.Model):
    ...
    lang = fields.Many2one("res.lang", "Language", invisible=True)
    ...
    def create(self, vals_list):
        results = super(WATemplate, self).create(vals_list)
        for res in results:
    ...
    def _get_carousel_params(self, component, object_data, provider, partner, cards):
            ...
            if component.type == 'header':
                ...
                for button in component.wa_button_ids:
                    ...
                    if button.button_type == 'phone':
                        button_dict.update({'type': 'PHONE_NUMBER', 'text': button.button_text,
                        ...
                        button_dict.update({'type': button.button_type.upper(),'example': button.coupon_text})
                        button_list.append(button_dict)
